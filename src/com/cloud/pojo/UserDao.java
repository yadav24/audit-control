...
public static User getEmailByName( String uname, String email, String pass, String repass, String seqques, String answer, int mobno)
{
	User u=new User(uname, email, pass, repass, seqques, answer, mobno);
	try
	{
		Connection con=UserDao.getConnection();
...
public static List<User> getAllUsers()
{
	...
	while(rs.next())
	{
		User u=new User(null, null, null, null, null, null, 0);
		u.setUname(rs.getString(1));
		u.setEmail(rs.getString(2));
		u.setPass(rs.getString(3));
		u.setRepass(rs.getString(4));
